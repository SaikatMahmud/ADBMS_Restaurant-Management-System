...
END;
=================================================
CREATE VIEW SHOW_CART AS SELECT OI.ORDER_ID,OI.ITEM_NO, OI.QUANTITY,(I.PRICE*OI.QUANTITY) AS ITEMTOTAL 
FROM ORDERED_ITEM OI,ITEMS I WHERE OI.ITEM_NO=I.ITEM_NO
=================================================
...
END;
=============================================
CREATE OR REPLACE PROCEDURE ADD_EMP(E_ID EMPLOYEES.EMPLOYEE_ID%TYPE,NAME EMPLOYEES.NAME%TYPE,ADD EMPLOYEES.ADDRESS%TYPE,HIRE VARCHAR2,JOB EMPLOYEES.JOB%TYPE, SAL EMPLOYEES.SALARY%TYPE,MOB EMPLOYEE_PHONE.PHONE_NUM%TYPE, M_ID EMPLOYEES.MANAGER_ID%TYPE, STAT OUT VARCHAR2)
IS
BEGIN
...
HIRE VARCHAR2,JB EMPLOYEES.JOB%TYPE, SAL EMPLOYEES.SALARY%TYPE,M_ID EMPLOYEES.MANAGER_ID%TYPE)
IS
BEGIN
UPDATE EMPLOYEES SET NAME=NM,ADDRESS=ADD,HIRE_DATE=TO_DATE(HIRE,'yyyy-mm-dd'),JOB=JB,SALARY=SAL,MANAGER_ID=M_ID WHERE EMPLOYEE_ID=E_ID;
END;
======================

CREATE OR REPLACE PROCEDURE EDIT_RES(REG RESTAURANTS.REG_NUM%TYPE,NM RESTAURANTS.NAME%TYPE,BR RESTAURANTS.BRANCH%TYPE,
CONTACT RESTAURANTS.CONTACT_NUM%TYPE,EM RESTAURANTS.EMAIL%TYPE, M_ID RESTAURANTS.MANAGER_ID%TYPE,PREV_REG RESTAURANTS.REG_NUM%TYPE)
IS
BEGIN
UPDATE RESTAURANTS SET REG_NUM=REG,NAME=NM,BRANCH=BR,CONTACT_NUM=CONTACT,EMAIL=EM,MANAGER_ID=M_ID WHERE REG_NUM=PREV_REG;
END;
=======================
...
PROCEDURE ADD_RES(R_NO RESTAURANTS.REG_NUM%TYPE,NAME RESTAURANTS.NAME%TYPE,BR RESTAURANTS.BRANCH%TYPE,CONTACT RESTAURANTS.CONTACT_NUM%TYPE, EMAIL RESTAURANTS.EMAIL%TYPE,MID RESTAURANTS.MANAGER_ID%TYPE, STAT OUT VARCHAR2);

PROCEDURE EDIT_RES(REG RESTAURANTS.REG_NUM%TYPE,NM RESTAURANTS.NAME%TYPE,BR RESTAURANTS.BRANCH%TYPE,
CONTACT RESTAURANTS.CONTACT_NUM%TYPE,EM RESTAURANTS.EMAIL%TYPE, M_ID RESTAURANTS.MANAGER_ID%TYPE,PREV_REG RESTAURANTS.REG_NUM%TYPE);
...
PROCEDURE ADD_RES(R_NO RESTAURANTS.REG_NUM%TYPE,NAME RESTAURANTS.NAME%TYPE,BR RESTAURANTS.BRANCH%TYPE,
          CONTACT RESTAURANTS.CONTACT_NUM%TYPE, EMAIL RESTAURANTS.EMAIL%TYPE,MID RESTAURANTS.MANAGER_ID%TYPE, STAT OUT VARCHAR2)
IS
BEGIN
IF (CHECK_UNIQUE_RES(R_NO) = 'TRUE') THEN
...
PROCEDURE ADD_EMP(E_ID EMPLOYEES.EMPLOYEE_ID%TYPE,NAME EMPLOYEES.NAME%TYPE,ADD EMPLOYEES.ADDRESS%TYPE,HIRE VARCHAR2,JOB EMPLOYEES.JOB%TYPE, SAL EMPLOYEES.SALARY%TYPE,MOB EMPLOYEE_PHONE.PHONE_NUM%TYPE, M_ID EMPLOYEES.MANAGER_ID%TYPE, STAT OUT VARCHAR2);

PROCEDURE EDIT_EMP(E_ID EMPLOYEES.EMPLOYEE_ID%TYPE,NM EMPLOYEES.NAME%TYPE,ADD EMPLOYEES.ADDRESS%TYPE,
HIRE VARCHAR2,JB EMPLOYEES.JOB%TYPE, SAL EMPLOYEES.SALARY%TYPE,M_ID EMPLOYEES.MANAGER_ID%TYPE);
...
END IF;
INSERT INTO LOG_INFO VALUES(LOG_SQ.NEXTVAL,OPNAME,'Employee',SYSDATE);
END;
==========================
...
OPNAME :='Delete operation';
END IF;
INSERT INTO LOG_INFO VALUES(LOG_SQ.NEXTVAL,OPNAME,'Restaurants',SYSDATE);
END;
==========================
...
OPNAME :='Delete operation';
END IF;
INSERT INTO LOG_INFO VALUES(LOG_SQ.NEXTVAL,OPNAME,'Items',SYSDATE);
END;
===========================
