...
END;
==================================================
CREATE OR REPLACE PROCEDURE GET_TEMP_ORDER_ITEMS(O_ID ORDERS.ORDER_ID%TYPE, CART OUT SYS_REFCURSOR)
IS
BEGIN
OPEN CART FOR SELECT O.ITEM_NO, O.QUANTITY,(I.PRICE*O.QUANTITY) AS ITEMTOTAL FROM ORDERED_ITEM O,
		ITEMS I WHERE O.ORDER_ID=O_ID AND O.ITEM_NO=I.ITEM_NO;
END;
